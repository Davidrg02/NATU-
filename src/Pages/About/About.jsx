...
export default function About(){
  return (
    ...
    <div id="about-us-container2">
      ...
      <p>Somos estudiantes de la Universidad Nacional formando un equipo de desarrolladores dedicados a crear soluciones innovadoras. Trabajamos juntos para enfrentar desafíos y generar impacto positivo.</p>
